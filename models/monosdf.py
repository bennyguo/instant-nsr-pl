...
from nerfacc import ContractionType, OccupancyGrid, ray_marching, rendering, render_weight_from_alpha, unpack_info, accumulate_along_rays
...
@models.register('monosdf')
class MonoSDFModel(BaseModel):
    def setup(self):
